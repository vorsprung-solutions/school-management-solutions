...
const CreateAttendancePage = () => {
  ...
  React.useEffect(() => {
    if (watchedStudent) {
      const student = students.find((s: IStudent) => s._id === watchedStudent);
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Add a new attendance record</p>
        </div>
      </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select onValueChange={(value) => setValue("student", value)}>
                    ...
                    <SelectContent>
                      {students
                        .filter((student: IStudent) => student._id)
        ...
        <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <p>
                    Class {selectedStudent.class} - Session{" "}
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm text-gray-600">
              ...
              <p>• Choose the attendance status</p>
              <p>• Set the date (defaults to today)</p>
              <p>• Add optional remarks if needed</p>
              <p>• Click "Create Attendance" to save</p>
            </CardContent>
          </Card>
        </div>
      </div>
